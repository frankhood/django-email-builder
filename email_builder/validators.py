...
def validate_subject_syntax(subject):
    """
    Validate if there are break lines in subject
    """
    if "\n" in subject or "<br>" in subject:
        raise ValidationError("Email subject can't have break lines")
